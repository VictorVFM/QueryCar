...
function renderVeiculo(data) {
  ...
  const result = `
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0"> 
      <tbody> 
        <tr>
          <td class="tl">Mês de referência</td>
          <td class="tr">${MesReferencia}</td>
        </tr>
        <tr>
          <td>Código FIPE</td>
          <td>${CodigoFipe}</td>
        ...
        <tr>
          <td class="bl">Preço Médio</td>
          <td class="br">${Valor}</td>
        </tr>
      </tbody>
    </table>
    ${
      ...
      `
        <br>
        <select class="busca" id="historico">
